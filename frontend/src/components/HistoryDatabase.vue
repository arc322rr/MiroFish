        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <div v-if="project.files.length > 3" class="files-more">
              +{{ project.files.length - 3 }} файлов
            </div>
          </div>
          <!-- 无文件时的占位 -->
          <div class="files-empty" v-else>
            <span class="empty-file-icon">◇</span>
            <span class="empty-file-text">Файлов нет</span>
          </div>
        </div>
        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">Навигация по шагам</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">Подготовка среды</span>
              </button>
              <button 
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Шаги 3 («Запуск симуляции») и 5 («Глубокое взаимодействие») требуют активного запуска и не поддерживают историческое воспроизведение</span>
            </div>
          </div>
        </div>
      </Transition>
