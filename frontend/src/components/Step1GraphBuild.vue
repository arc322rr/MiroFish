    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM анализирует документы и задачу симуляции, извлекает исходные данные и автоматически строит онтологию.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            На основе онтологии документы автоматически разбиваются на фрагменты, через Zep строится граф знаний, извлекаются сущности и связи, формируется временная память и сводки сообществ.
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Ребра связей</span>
            </div>
            <div class="stat-card">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase >= 2" class="badge accent">Готово</span>
          </div>
        </div>
        
        <div class="card-content">
          <p class="api-note">POST /api/simulation/create</p>
          <p class="description">Построение графа завершено. Переходите к следующему шагу для подготовки среды симуляции.</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Создание...' : 'Перейти к подготовке среды ➝' }}
          </button>
        </div>
      </div>
    </div>
