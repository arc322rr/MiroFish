  ...
  <div class="graph-panel">
    <div class="panel-header">
      ...
      <div class="header-tools">
        ...
        <button class="tool-btn" @click="$emit('toggle-maximize')" title="Развернуть/восстановить">
    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? 'Выполняется обновление долгосрочной и краткосрочной памяти GraphRAG' : 'Обновляется в реальном времени...' }}
        </div>
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">Осталось обработать небольшую часть данных, обновите граф чуть позже</span>
